...
You must create an account to use most features. You are responsible for keeping your credentials secure and for all activity under your account. You must be at least 18 years old to register.
...
This section applies to the contract matching feature of the Platform.

When a client posts a contract, they are expressing an interest in receiving services. When a service provider applies to a contract, they are purchasing access to that client's contact information as a qualified lead introduction.

**We do not guarantee any outcome.** Specifically:

- We do not guarantee that a deal will be made between any two parties.
- We do not guarantee that the client is ready, willing, or able to proceed with any agreement.
...
Payments are processed by a third-party provider (Stripe). By completing a payment, you agree to their terms as well. We do not store your payment card details.
...
We may update these terms from time to time. We will notify you of significant changes via the Platform or by email. Continued use after changes take effect means you accept the updated terms.

---

## 7. Governing Law

These terms are governed by the laws of Poland. Any disputes shall be resolved before the competent courts of Poland, without prejudice to your rights as a consumer under EU law.
